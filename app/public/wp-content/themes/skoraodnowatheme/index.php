    ...
    <article class="content-wrapper">
      ...
      <div class="news-card">
        ...
        <div class="news-card__text-wrapper">
          <h2 class="h2-title">Amazing First Title</h2>
      ...
      <div class="news-card">
        ...
        <img
          ...
          alt="" class="news-card__image">
        <div class="news-card__text-wrapper">
          <h2 class="h2-title">Amazing Forth Title that is Quite Long</h2>
          <div class="news-card__post-date">Jan 29, 2018</div>
          <div class="news-card__details-wrapper">
            <p class="p-normal p-normal--small">Lorem ipsum dolor sit amet!</p>
      ...
      <div class="news-card">
        ...
        <img
          ...
          alt="" class="news-card__image">
        <div class="news-card__text-wrapper">
          <h2 class="h2-title">Amazing Fifth Title</h2>
          <div class="news-card__post-date">Jan 29, 2018</div>
          <div class="news-card__details-wrapper">
            <p class="p-normal p-normal--small">Lorem ipsum dolor sit amet consectetur adipisicing elit. Est pariatur
              nemo
      ...
      <div class="news-card">
        ...
        <img
          ...
          alt="" class="news-card__image">
        <div class="news-card__text-wrapper">
          <h2 class="h2-title">Amazing 6<sup>th</sup> Title</h2>
          <div class="news-card__post-date">Jan 29, 2018</div>
          <div class="news-card__details-wrapper">
            <p class="p-normal p-normal--small">Lorem ipsum dolor sit amet consectetur adipisicing elit. Est pariatur
              nemo
